                ...
                <div className="c-first-container">
                    <div className="c-image-upload-block">
                        ...
                        >
                                ...
                                <textarea placeholder="Try to describe how to make your cocktail..." className="o-text-area" cols="42" rows="7" name="strInstructions" onChange={this.handleInput}></textarea>
                    ...
                    <div className="c-form-container">
                        <div className="o-input-and-article">
                            ...
                            <input placeholder="(Important) example: Blood Marry" className="o-input o-input_createrecipe" name="strDrink" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Category</div>
                            <input placeholder="(Important) example: Ordinary" className="o-input o-input_createrecipe" name="strCategory" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Alcoholic</div>
                            <input placeholder="(Important) example: Alcoholic" className="o-input o-input_createrecipe" name="strAlcoholic" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Glass</div>
                            <input placeholder="(Important) example: Cocktail Glass" className="o-input o-input_createrecipe" name="strGlass" type="text" onChange={this.handleInput} />
                        </div>
                        <article className="o-title">Ingredients</article>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient1</div>
                            <input placeholder="(Important) ex: Apple" className="o-input o-input_createrecipe o-input-small" name="strIngredient1" type="text" onChange={this.handleInput} />
                            <div className="o-title-input">Measure1</div>
                            <input placeholder="(Important) ex: 1/4" className="o-input o-input_createrecipe o-input-small" name="strMeasure1" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient2</div>
                            <input placeholder="(Important) ex: Salt" className="o-input o-input_createrecipe o-input-small" name="strIngredient2" type="text" onChange={this.handleInput} />
                            <div className="o-title-input">Measure2</div>
                            <input placeholder="(Important) ex: 1.5 gr" className="o-input o-input_createrecipe o-input-small" name="strMeasure2" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient3</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strIngredient3" type="text" onChange={this.handleInput} />
                            <div className="o-title-input">Measure3</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strMeasure3" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient4</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strIngredient4" type="text" onChange={this.handleInput} />
                            <div className="o-title-input">Measure4</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strMeasure4" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient5</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strIngredient5" type="text" onChange={this.handleInput} />
                            <div  className="o-title-input">Measure5</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strMeasure5" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient6</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strIngredient6" type="text" onChange={this.handleInput} />
                            <div className="o-title-input">Measure6</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strMeasure6" type="text" onChange={this.handleInput} />
                        </div>
                        <div className="o-input-and-article">
                            <div className="o-title-input">Ingredient7</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strIngredient7" type="text" onChange={this.handleInput} />
                            <div className="o-title-input">Measure7</div>
                            <input placeholder="(Additional Value)" className="o-input o-input_createrecipe o-input-small" name="strMeasure7" type="text" onChange={this.handleInput} />
                        </div>
                    </div>
                </div>
